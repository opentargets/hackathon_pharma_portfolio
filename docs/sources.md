...
| Roche | `roche.com/solutions/pipeline` | Semi-annual (H1/H2) | Done — see [`pharmas/roche/log.md`](../pharmas/roche/log.md) |
...
| Novo Nordisk | `https://novonordisk.com/science-and-technology/r-d-pipeline.html` | Interactive, filterable by phase and therapeutic area. Small pipeline, diabetes/obesity-heavy. | Done — see [`pharmas/novonordisk/log.md`](../pharmas/novonordisk/log.md) |
